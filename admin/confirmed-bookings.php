...
<head>
	...
	<title>Car Rental Portal | Reservas confirmadas   </title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Informações das reservas</div>
...
if($result->Status==0)
{
echo htmlentities('Ainda não confirmado');
...
<a href="bookig-details.php?bid=<?php echo htmlentities($result->id);?>"> Ver</a>
</td>
