...
$query -> execute();
$msg="Registro do veículo excluído com sucesso";
}
...
<head>
	...
	<title>Car Rental Portal | Gerenciar veiculos   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gerenciar veiculos</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Detalhes dos veiculos</div>
