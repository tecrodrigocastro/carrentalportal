...
$query -> execute();
$msg="Informações de assinantes deletadas";
...
<head>
	...
	<title>Car Rental Portal | Gerenciar assinantes   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Gerenciar assinantes</h2>
...
<a href="manage-subscribers.php?del=<?php echo $result->id;?>" onclick="return confirm('Você quer deletar');"><i class="fa fa-close"></i></a>
</td>
