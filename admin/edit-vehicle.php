...
<head>
	...
	<title>Car Rental Portal | Editar veiculo</title>
...
<label class="col-sm-2 control-label">Nome do veiculo<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Selecione a marca<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Preço por dia(em USD)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Tipo de combustivel<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="changeimage4.php?imgid=<?php echo htmlentities($result->id)?>">Imagem 4</a>
</div>
<div class="col-sm-4">
Image 5
...
<a href="changeimage5.php?imgid=<?php echo htmlentities($result->id)?>">Imagem 5</a>
<?php } ?>
</div>
...
<label for="inlineCheckbox2"> Travas elétricas </label>
</div>
<?php } else {?>
...
<label for="inlineCheckbox3"> Sistema de travagem anti-bloqueio </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Assistente de freio </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox1"> Direção Hidráulica </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Airbag do motorista</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Air Bag do passageiro </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox3"> Janela eletrica </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
...
<label for="inlineCheckbox2">Travamento central</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
