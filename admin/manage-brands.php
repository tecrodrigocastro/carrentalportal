...
$query -> execute();
$msg="Dados da página atualizados com sucesso";
...
<head>
	...
	<title>Car Rental Portal | Gerenciar Marcas   </title>
...
<a href="manage-brands.php?del=<?php echo $result->id;?>" onclick="return confirm('Você quer deletar');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
