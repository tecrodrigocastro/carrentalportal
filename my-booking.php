...
<title>Car Rental Portal - Minhas reservas</title>
<!--Bootstrap -->
...
<li>
    <h4 style="color:red">Reserva n #<?php echo htmlentities($result->BookingNumber);?></h4>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>A partir de </b> <?php echo htmlentities($result->FromDate);?> <b>Para </b> <?php echo htmlentities($result->ToDate);?></p>
                  <div style="float: left"><p><b>Mensagem:</b> <?php echo htmlentities($result->message);?> </p></div>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelado</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Ainda não confirmado</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
...
<table>
  ...
  <tr>
    <th colspan="4" style="text-align:center;"> Total geral</th>
    <th><?php echo htmlentities($tds*$ppd);?></th>
  </tr>
</table>
<hr />
              <?php }}  else { ?>
                <h5 align="center" style="color:red">Sem reservas</h5>
              <?php } ?>
