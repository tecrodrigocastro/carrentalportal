...
if($lastInsertId)
{
$msg="Consulta enviada. Entraremos em contato em breve";
}
else 
{
...
<title>Car Rental|| Contato</title>
<!--Bootstrap -->
...
<section class="contact_us section-padding">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>Entre em contato pelo formulário abaixo</h3>
        ...
        <div class="contact_form gray-bg">
          <form  method="post">
            ...
            <div class="form-group">
              <label class="control-label">Numero telefone <span>*</span></label>
            ...
            <div class="form-group">
              <button class="btn" type="submit" name="send" type="submit">Enviar mensagem<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
