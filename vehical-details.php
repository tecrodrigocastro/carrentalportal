...
if($lastInsertId)
{
echo "<script>alert('Reserva com sucesso.');</script>";
...
echo "<script>alert('Algo deu errado. Por favor, tente novamente');</script>";
 ...
 echo "<script>alert('Carro já reservado para estes dias');</script>"; 
 echo "<script type='text/javascript'> document.location = 'car-listing.php'; </script>";
}
...
<title>Car Rental | Detalhes do veiculo</title>
<!--Bootstrap -->
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Visão geral </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Acessorios</a></li>
            </ul>
...
<tr>
<td>Sistema de travagem anti-bloqueio</td>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true"></i>Reserve agora</h5>
          </div>
          <form method="post">
            <div class="form-group">
              <label>Da data:</label>
              <input type="date" class="form-control" name="fromdate" placeholder="Da data" required>
            </div>
            <div class="form-group">
              <label>Até a data:</label>
              <input type="date" class="form-control" name="todate" placeholder="Até a data" required>
            </div>
            <div class="form-group">
              <textarea rows="4" class="form-control" name="message" placeholder="Mensagem" required></textarea>
            </div>
          <?php if($_SESSION['login'])
              {?>
              <div class="form-group">
                <input type="submit" class="btn"  name="submit" value="Reserva agora">
              </div>
              <?php } else { ?>
