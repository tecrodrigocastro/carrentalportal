...
if($lastInsertId)
{
echo "<script>alert('Registro bem-sucedido. Agora você pode entrar');</script>";
}
else 
{
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
              ...
              <form  method="post" name="signup" onSubmit="return valid();">
                <div class="form-group">
                  <input type="text" class="form-control" name="fullname" placeholder="Nome completo" required="required">
                      ...
                      <div class="form-group">
                  <input type="text" class="form-control" name="mobileno" placeholder="Telefone" maxlength="10" required="required">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <input type="password" class="form-control" name="confirmpassword" placeholder="Confirma senha" required="required">
                </div>
                ...
                <div class="form-group">
                  <input type="submit" value="Criar" name="signup" id="submit" class="btn btn-block">
                </div>
              </form>
            </div>
      ...
      <div class="modal-footer text-center">
        <p>Já tenho uma conta? <a href="#loginform" data-toggle="modal" data-dismiss="modal">Login aqui</a></p>
      </div>
    </div>
  </div>
</div>