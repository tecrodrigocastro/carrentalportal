...
echo "Bem-vindo ao portal de aluguel de automóveis";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            ...
            <li><a href="my-booking.php">Minha reserva</a></li>
            <li><a href="post-testimonial.php">Postar depoimento</a></li>
        ...
        <div class="header_search">
          ...
          <form action="search.php" method="post" id="header-search-form">
            <input type="text" placeholder="Procurar..." name="searchdata" class="form-control" required="true">
