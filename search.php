...
<title>Car Rental Portal | Procurar</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Resultado da pesquisa da palavra-chave "<?php echo $_POST['searchdata'];?>"</h1>
      </div>
...
$cnt=$query->rowCount();
?>
<p><span><?php echo htmlentities($cnt);?> Listagens encontradas</span></p>
</div>
</div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn">Detalhes <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
...
<option value="CNG">CNG</option>
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Procurar </button>
              </div>
            </form>
          </div>
        </div>
